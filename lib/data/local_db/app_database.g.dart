    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `Posts` (`id` TEXT NOT NULL, `title` TEXT NOT NULL, `postDesc` TEXT NOT NULL, `imageUrl` TEXT NOT NULL, PRIMARY KEY (`id`))');
  ...
  Future<List<Posts>> findAllPosts() async {
    return _queryAdapter.queryList('SELECT * FROM Posts',
        mapper: (Map<String, Object?> row) => Posts(
            row['id'] as String,
            row['title'] as String,
            row['postDesc'] as String,
            row['imageUrl'] as String));
  }

  @override
  Future<void> insertPost(Posts posts) async {
    await _postsInsertionAdapter.insert(posts, OnConflictStrategy.abort);
  }
}
